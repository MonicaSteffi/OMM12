exc2gffv2Fin=function(AnnFile,genomeID,type1,start1,end1,strand1,attrVec,annType,newGff_folder,gnmNames)
{
  ...
  gffDf=data.frame(Start=tmpExcl[,start1],End=tmpExcl[,end1],Strand=tmpExcl[,strand1],Type=(tmpExcl[,type1]),GenomeID=tmpExcl[,genomeID])
    ...
    newGff=str_c(newGff_folder,gnmNames,"_",annType,"_genious_annotation.gff")
