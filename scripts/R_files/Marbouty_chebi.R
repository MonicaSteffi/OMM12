CheBIUniRDS=list.files(path = "FinalAnnv2=(readRDS(str_c("S:/Abilash/Marbouty_annotation_refseq_genbank 11_2021/Data/Marbouty_annotations_for_integrated_proteins/",gnmNmsThis,"_FinalAnnWithCheBIUniprotFin.rds")))
",pattern = "_FinalAnnWithCheBIUniprotFin.rds",full.names = T)
...
baseDir="C:/Users/subha/Downloads/Mt1B1_genbank_refseq_joint_proteins/"
